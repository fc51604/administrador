    ...
    <div class="banner-image w-100 vh-100 d-flex justify-content-center align-items-center pt-5 ">
        <div class="container profile-container">
            <div class="breaddiv" aria-label="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="/propriedadesFind">Find Property</a></li>
                <li class="breadcrumb-item active" aria-current="page">Property Profile</li>
                </ol>
            </div>
            <div class="row">
